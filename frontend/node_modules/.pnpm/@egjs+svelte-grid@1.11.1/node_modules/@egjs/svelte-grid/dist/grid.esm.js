...
import { GRID_EVENTS, GRID_METHODS, MasonryGrid as MasonryGrid$1, JustifiedGrid as JustifiedGrid$1, FrameGrid as FrameGrid$1, PackingGrid as PackingGrid$1 } from '@egjs/grid';
...
if (typeof Grid$1 === "object") {
  ...
  MasonryGrid = class MasonryGrid extends Grid$1 {
    constructor(options) {
      options.props.GridClass = MasonryGrid$1;
      super(options);
    }
...
if (typeof Grid$1 === "object") {
  JustifiedGrid = Grid$1;
} else {
  JustifiedGrid = class JustifiedGrid extends Grid$1 {
    constructor(options) {
      options.props.GridClass = JustifiedGrid$1;
      super(options);
    }
...
if (typeof Grid$1 === "object") {
  ...
  FrameGrid = class FrameGrid extends Grid$1 {
    constructor(options) {
      options.props.GridClass = FrameGrid$1;
      super(options);
    }
...
if (typeof Grid$1 === "object") {
  ...
  PackingGrid = class PackingGrid extends Grid$1 {
    constructor(options) {
      options.props.GridClass = PackingGrid$1;
      super(options);
    }

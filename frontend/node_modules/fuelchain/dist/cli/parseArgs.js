...
function parseArgs() {
    const rawOptions = (0, ts_command_line_args_1.parse)({
        ...
        target: {
            type: String,
            description: 'typechain-target-fuels or path to your custom target. Typechain will try to load package named: @typechain/<target>, so make sure that desired package is installed.',
        },
        'out-dir': {
            type: String,
            optional: true,

...
async function runTypeChain(publicConfig) {
    const ChainTarget = (0, findTarget_1.findTarget)(publicConfig.target);
    const allFiles = (0, io_1.skipEmptyAbis)(publicConfig.allFiles, ChainTarget.extractAbi);
    // skip empty paths
    const config = {
        ...
        ...publicConfig,
        allFiles,
        filesToProcess: (0, io_1.skipEmptyAbis)(publicConfig.filesToProcess, ChainTarget.extractAbi),
    };
    const services = {
        fs,
        prettier,
